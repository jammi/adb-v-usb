 ...
 * ├─────┬──┴─┬─┴──┬┴───┴───┴───┴───┴───┴───┴┬──┴──┬┴───┬──────┤ ╭───┼───┼───╮ ├───┴───┼───┤Ent│
 * │Ctrl │Opt │Cmd │         Space           │     │Opt │Ctrl  │ │ ◀︎ │ ▼ │ ► │ │      0│  .│   │
 * ╰─────┴────┴────┴─────────────────────────┴─────┴────┴──────╯ ╰───┴───┴───╯ ╰───────┴───┴───╯
 */
...
/* Apple Extended Keyboard International (model M3501)
 * ╭───╮   ╭───┬───┬───┬───╮ ╭───┬───┬───┬───╮ ╭───┬───┬───┬───╮ ╭───┬───┬───╮             ╭───╮
 * │Esc│   │F1 │F2 │F3 │F4 │ │F5 │F6 │F7 │F8 │ │F9 │F10│F11│F12│ │F13│F14│F15│             │◀︎  │
 * ╰───╯   ╰───┴───┴───┴───╯ ╰───┴───┴───┴───╯ ╰───┴───┴───┴───╯ ╰───┴───┴───╯             ╰───╯
 * ╭───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────╮ ╭───┬───┬───╮ ╭───────────────╮
 * │  §│  1│  2│  3│  4│  5│  6│  7│  8│  9│  0│  -│  =│Backspa│ │Hlp│Hom│PgU│ │Clr│  =│  /│  *│
 * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┤ ├───┼───┼───┤ ├───┼───┼───┼───┤
 * │Tab  │  Q│  W│  E│  R│  T│  Y│  U│  I│  O│  P│  [│  ]│  Re │ │Del│End│PgD│ │  7│  8│  9│  -│
 * ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┐ tu │ ╰───┴───┴───╯ ├───┼───┼───┼───┤
...
#define KEYMAP_M0487( \
   ...
   K36,K00,K01,K02,K03,K05,K04,K26,K28,K25,K29,K27,K2A,K24, K56,K57,K58,K4E, \
   K38,K32,K06,K07,K08,K09,K0B,K2D,K2E,K2B,K2F,K2C,K7B,K3E, K53,K54,K55,     \
   K39,K3A,K37,            K31,                K3B,K3C,K3D, K52,    K41,K4C  \
) { \
  KC_##K00, KC_##K01, KC_##K02, KC_##K03, KC_##K04, KC_##K05, KC_##K06, KC_##K07, \
  KC_##K08, KC_##K09, KC_##K0A, KC_##K0B, KC_##K0C, KC_##K0D, KC_##K0E, KC_##K0F, \
  KC_##K10, KC_##K11, KC_##K12, KC_##K13, KC_##K14, KC_##K15, KC_##K16, KC_##K17, \
